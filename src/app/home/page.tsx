...
const HomePage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-purple-primary flex items-center justify-center">
           <div className="relative bg-white-100 mx-2 pt-16 mt-48 my-44 rounded-tl-[2.5rem] rounded-tr-[2.5rem] rounded-bl-[2.5rem] shadow-md w-full max-w-md">
                <div>
                ...
                <div className="bg-danger-100 rounded-[2rem] mt-8 py-4 px-6 mx-4 flex flex-col items-left">
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-8 my-16 mx-4">
